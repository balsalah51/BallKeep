...
def ledger_article_html() -> str:
    ...
    <article class="opening essay recap">
      ...
      <p>That change is small on the page and large at the table. You can sort The Keep and still see that the second running back on a Superflex dynasty board is a different sentence from the second running back on The Board, because The Keep is years and The Board is this season, and a name can be RB4 in one room and RB1 in the other without either list being confused. Weekly does the same thing for Sunday, Best Ball does it for boom weeks, and The Fence does it for the mixed board, so a person who came here for a number still gets the number and also gets the chair the room already uses when the clock is running.</p>

      <h2>What Week 2 did to the chairs</h2>
      <p>Ja'Marr Chase spent the opener on twelve yards and then spent Houston on two touchdowns, which is a WR1 week from a WR1 name the Super Aggregate already treated like one. The buy was the empty opener and the receipt is the 20-6 road win, and a room that still has him as a faded WR2 because of one Thursday is talking to a person who watches the first chapter and closes the book.</p>
      <p>Jalen Coker is the other receiver sentence, eight for 138 and two against Chicago and then 76 percent of the snaps in a 34-3 win in Atlanta, Young finding him in a game that already had Waller twice. Waiver lists still have him first or second wherever anyone left him out there, and on our lists he will show as whatever chair the mash gives him, and that chair is climbing. Year-two leaps look like this when they are real, and they look like this when they are a two-week spike, which is why you pay the snap share and leave the career price on the table until he does it in a colder game.</p>
      ...
      <p>On The Keep, RB2 is a years sentence. Bijan and Gibbs have been that sentence all summer, and a 72-yard afternoon in a 34-3 loss does not evict Bijan from the long board any more than a short week in Buffalo evicts Gibbs. You start them this Sunday when they dress, and you leave them on the roster when one script is ugly, because climate is slow on purpose.</p>
      <p>On The Board, RB2 is a this-year sentence. Christian McCaffrey just scored his 100th touchdown and still has to share a backfield with Kaelon Black, Kenneth Walker just ran for 117 in overtime after 173 on opening night, and James Cook just ran for 134 in a 41-point Thursday. Those chairs move faster because the season is the product. A 2026-only draft should trust The Board's RB2 more than The Keep's, and a 2028 draft should do the opposite, which is the whole reason the two lists exist in the same house.</p>
      <p>On Weekly, RB2 is a Sunday sentence. Henderson can be that for a week, Coleman can be that for a week, and Swift can fall out of it after a rain night. The weekly boards stay on Week 2 until the next card is a real card, and they are the page you open when you are naming a starter, the way The Keep is the page you open when you are naming a trade and The Board is the page you open when a redraft friend wants to settle an argument. The chair number is there so you stop asking the table to count.</p>
      ...
      <h2>The job the list used to hide</h2>
      <p>I keep coming back to the simple picture of a manager sitting with a laptop on a Tuesday, the waiver already open, the chat already loud, and a list that used to say RB next to twelve names as if those twelve names were the same job. They were never the same job. The second back on a Superflex dynasty board is a building, and the second back on a weekly board is a Sunday, and printing RB2 is how we stop pretending those two sentences share a chair.</p>
      <p><a href="week2-tape.html">The Second Sunday</a> still holds the week, <a href="hot-n-cold.html">Hot 'n' Cold</a> still holds the ten names to buy and the ten names to sell, The Keep still holds the years, and The Board still holds this season. This page is for the manager who wants the lists to talk the way the room already talks, and who is willing to sit with a second week long enough to remember which interruptions deserve a new chair and which ones are just weather.</p>
