...
W1_DST_SOURCES = [
    ...
    ("FantasyPros Week 1 DST ECR", "https://www.fantasypros.com/nfl/rankings/dst.php", "Weekly expert consensus, Sep 9. Jaguars first."),
...
W1_K_SOURCES = [
    ...
    ("FantasyPros Week 1 K ECR", "https://www.fantasypros.com/nfl/rankings/k.php", "Weekly expert consensus, Sep 9. Aubrey first."),
