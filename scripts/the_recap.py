...
def recap_article_html():
    ...
    <article class="opening recap">
      ...
      <p>Jacksonville 34, Cleveland 10. The Jaguars did what the Week 1 defense boards asked them to do. Trevor Lawrence had the kind of clean afternoon that Liam Coen's second year is supposed to look like. The Browns spent the day chasing. If you streamed Jacksonville, you already cashed. If you sat them because you wanted to be clever, the stream is gone and Week 2 is Denver on the road, which is a colder ask.</p>
      ...
      <p>I keep thinking about what a 59-point night does to a fantasy room. It makes people believe in a whole offense for four months. Sometimes that belief is correct. Chicago hosts Minnesota in Week 2, which is a different animal than Carolina at home. Cairo Santos is on every kicker streamer list. The Bears defense gave up 37. Start the skill names. Treat the defense like a matchup.</p>
      ...
      <p>Philadelphia 24, Washington 22. Jalen Hurts' club survived a game that kept threatening to become a story about Washington. Jacory Croskey-Merritt scored early for the Commanders. The Eagles closed it. Week 2 is Tennessee on the road, and the defense boards have Philadelphia first or second on almost every list I mashed. That is the stream if you already own them. If you do not, the waiver price is high.</p>
