...
def opening_article_html():
    ...
    <article class="opening">
      ...
      <p>Jaxon Smith-Njigba still produced after Lock entered, so rooms that rostered him already have his Week 1 line and should keep him in for Week 2 even with Lock starting. The waiver names that moved on the wire are <a href="players/romeo-doubs.html">Romeo Doubs</a> and <a href="players/demario-douglas.html">DeMario Douglas</a>, and Douglas comes first among New England receivers while Brown sits, with Doubs next for rooms that still need a wideout this weekend. Jadarian Price can wait on the wire until he actually plays a real snap share.</p>
      ...
      <p>Most of Week 1 has not been played, and the <a href="weekly.html">weekly boards</a> still set the remaining slates. Rooms that started Darnold already need Lock or a Sunday stream while the hip heals, rooms that started Brown need a receiver from the leftover games or from <a href="waiver.html">waivers</a> while the high-ankle sprain runs its course, and rooms that sat Purdy left three touchdowns on the table.</p>
