...
HEADLINE = "Seattle 13-10. Melbourne 27-7. Sunday still has to play."
DEK = (
    "The Seahawks beat the Patriots on Wednesday. The 49ers beat the Rams on Thursday "
    "in Australia. Sam Darnold is expected to miss Week 2. A.J. Brown is looking at "
    "multiple weeks. Brock Purdy already put three touchdowns on the board."
)
...
def opening_teaser():
    ...
    <a class="opening-teaser" href="week1-opening.html">
      ...
      <div>
        ...
        <p>What the first two games do to leftover Sunday lineups and the first waiver list of the year.</p>
      </div>
    </a>
    """
    ...
    <article class="opening">
      ...
      <div class="score-row">
        <div class="score-card">
          ...
          <p class="meta">Super Bowl rematch. Lumen Field. Darnold out. Lock closed it.</p>
        </div>
        <div class="score-card">
          <p class="when">Thu, Sep 10 · Netflix · Melbourne</p>
          <p class="result">49ers 27, Rams 7</p>
          <p class="meta">First regular-season NFL game in Australia. Purdy, three touchdowns.</p>
        </div>
      </div>
      ...
      <p class="photo-cap">Maye, Darnold, Lock, Brown, Smith-Njigba, Purdy, McCaffrey, Nacua. The first two nights already moved Sunday and Week 2.</p>

      <p class="lede">Week 1 opened on two continents before most of the league had taken a snap. New England went to Seattle on Wednesday and lost 13-10. San Francisco and Los Angeles then played in Melbourne, and the 49ers left Australia with a 27-7 win. Those scores already sit in Week 1 totals. They also open holes for the Sunday remainder and set the first waiver list of the year.</p>

      <h2>Wednesday in Seattle</h2>
      <p>The rematch lasted one series for Sam Darnold. He left in the first quarter after a sack, went to the locker room, and was ruled out before halftime with a hip injury. A CT scan ruled out a fracture. Coach Mike Macdonald said Thursday that the early news was "really, really good," and that Darnold is still expected to miss next week at Arizona. Tom Pelissero reported Drew Lock as the likely Week 2 starter against the Cardinals.</p>
      ...
      <p>A.J. Brown left in the third quarter in a walking boot. X-rays were negative. Ian Rapoport and Mike Garafolo reported a right high-ankle sprain. Early reporting pointed to about three to four weeks. New England avoided a fracture. The calendar still knocks Brown out of the Sunday remainder and, at minimum, the next few weeks.</p>
      ...
      <figure>
        ...
        <figcaption>Drake Maye threw three fourth-quarter interceptions. A.J. Brown left in a walking boot with a high-ankle sprain.</figcaption>
      </figure>
      ...
      <div class="ramif">
        ...
        <ul>
          ...
          <li>Stash Brown or move him to IR if your league allows it. Fade him for at least the next three weeks.</li>
      ...
      <p>Rookie receiver <a href="players/dezhaun-stribling.html">De'Zhaun Stribling</a> left on a non-contact ankle play, was carted, and was ruled out. Shanahan said the Achilles is intact. An MRI will set the rest. Tight end Jake Tonges hurt his knee. Shanahan called the MCL sprain "not good."</p>
      <p>Puka Nacua, Kyren Williams, and Davante Adams already spent their Week 1 snaps in a 7-point loss. Those points are in. Week 2 is a new slate. Do not drop a Rams skill name because Thursday was ugly in Melbourne.</p>
      ...
      <div class="ramif">
        ...
        <ul>
          ...
          <li>Stash Stribling if you have a bench spot. Wait for the MRI before you spend real FAAB.</li>
          <li>Fade Tonges until the MCL timeline is public.</li>
