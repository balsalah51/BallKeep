...
def tape_article_html() -> str:
    ...
    <article class="opening recap">
      ...
      <p>I told rooms on Wednesday to put Nacua back in and to hold Adams and Kyren, and Monday split the advice the way a real week does: Adams paid immediately, Nacua sat with the hip, and Kyren caught a score. The tree is still Nacua's when he dresses, and it was Adams's when he did not, which is why you buy the missed night from the manager who only watched 195 and you start the veteran who just caught it until the hip report changes.</p>
      ...
      <p>Two young quarterbacks left on carts or with a trainer, and Williams and Daniels are Keep names with weeks they cannot play, which is when Superflex rooms that just watched 0-2 and a medical tent start selling years for a stream. That is the trade you want to be on the other side of. Bryce Young just put up back-to-back explosions and is still sitting in a lot of those same rooms, TreVeyon Henderson announced himself in Foxborough, Jonah Coleman is the Denver add after Dobbins, Jalen Coker is still the Carolina add wherever anyone left him out there after 138, and Chase reminded everyone why the twelve-yard opener was a buy.</p>
      ...
      <p>The <a href="weekly.html">weekly boards</a> still carry Week 2 on them, because the card just closed and the next Sunday is still a rumor. The <a href="hot-n-cold.html">Hot 'n' Cold</a> list moved this morning, the <a href="week2-matchups.html">prediction page</a> now has every receipt under the table, and The Keep and The Board rebuilt from the public lists we can still read. Spend the ranks with the story, and then spend the wire on the names this card actually moved.</p>
