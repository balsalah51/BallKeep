...
def test_football_nav_keeps_every_link():
    ...
    assert [lab for _h, lab in NAV] == [
        ...
        "ADP", "Trade", "The Split", "The Inheritance", "The Method",
        "My Team",
...
def test_visible_desk_copy_removed():
    ...
    for name in (
        ...
        "two_clocks.py", "the_split.py", "the_inheritance.py", "the_next_chair.py", "the_recap.py",
    ):
...
def test_home_page_markup():
    ...
    assert "css/site.css?v=68" in doc
