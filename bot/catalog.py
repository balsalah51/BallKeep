...
class Catalog:
    ...
    def list_for(self, board: str) -> list[dict]:
        key = {
            ...
            "top kickers": "kickers",
            "week1 dst": "week1_dst",
            "week 1 dst": "week1_dst",
            "week1_dst": "week1_dst",
            "week1 kickers": "week1_kickers",
            "week 1 kickers": "week1_kickers",
            "week1_kickers": "week1_kickers",
            "week1 matchups": "week1_matchups",
            "week 1 matchups": "week1_matchups",
            "week1_matchups": "week1_matchups",
            "fence": "fence",
            "the fence": "fence",
            "idp": "fence",
            "dynasty idp": "fence",
    ...
    def find(self, query: str, limit: int = 8, sport: str | None = None) -> list[dict]:
        ...
        if len(out) < limit and sport != "baseball":
            for board_key in ("keep", "board", "ppr", "standard", "classic", "best_ball", "dst", "kickers", "rookies"):
